...
export const emptyStage = app.querySelector("#emptyStage");
...
export const cartCountOutside = app.querySelector("#cartCountOutside");
export const cartCountInside = app.querySelector("#cartCountInside");

export const categoryList = app.querySelector("#categoryList");
export const categoryItem = app.querySelector("#categoryItem");

export const productCard = app.querySelector("#productCard");
export const productList = app.querySelector("#productList");
export const productListContainer = app.querySelector("#productListContainer");

export const starUi = app.querySelector("#starUi");
